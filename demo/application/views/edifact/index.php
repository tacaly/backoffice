      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Manage EDIFACT</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Add EDIFACT</h4>
      </div>
      ...
      <form role="form" action="<?php echo base_url('Customers/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="brand_name">EDIFACT Name</label>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-default" data-park="modal">Park</button>
...
<?php if(in_array('updateEdifact', $user_permission)): ?>
<!-- edit brand modal -->
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('Edifact/update') ?>" method="post" id="updateForm">

        <div class="modal-body">
          <div id="messages"></div>

          <div class="form-group">
            <label for="edit_brand_name">Edifact Name</label>
            <input type="text" class="form-control" id="edit_edifact_name" name="edit_edifact_name" placeholder="Enter Edifact name" autocomplete="off">
          </div>
          <div class="form-group">
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Remove Edifact</h4>
      </div>

      <form role="form" action="<?php echo base_url('Edifact/remove') ?>" method="post" id="removeForm">
        <div class="modal-body">
